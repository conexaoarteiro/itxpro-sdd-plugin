...
5. Qualidade: erro tratado, sem código morto, sem complexidade que não se paga, teste cobrindo o comportamento crítico.
6. O build, o lint e os testes passam? Rode e confirme.
